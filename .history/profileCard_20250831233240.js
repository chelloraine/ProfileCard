...
export default function ProfileCard() {
  ...
  const barHeight1 = useRef(new Animated.Value(10)).current;
  const barHeight2 = useRef(new Animated.Value(15)).current;
  const barHeight3 = useRef(new Animated.Value(12)).current;
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.info}>
        ...
        <Text style={styles.bio}>Building tech projects | IT Student | Coffee & Code ☕</Text>
      ...
      <TouchableOpacity style={[styles.followButton, following && styles.followingButton]} onPress={toggleFollow}>
...
const styles = StyleSheet.create({
  ...
  musicPlayer: { backgroundColor: "#1e1e1e", padding: 15, borderRadius: 15, width: "100%", alignItems: "center" },
  songTitle: { color: "#aaa", fontSize: 12, marginBottom: 3 },
  songName: { color: "#fff", fontSize: 16, fontWeight: "bold", marginBottom: 8 },
  barsContainer: { flexDirection: "row", justifyContent: "space-between", width: 80 },
  bar: { width: 8, backgroundColor: "#1DB954", borderRadius: 4 },
});
